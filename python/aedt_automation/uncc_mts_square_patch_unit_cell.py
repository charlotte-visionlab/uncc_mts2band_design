...
sub_wavelength_factor = wavelength / 5e-3
# height = 1.57e-3  # m
height = 2.54e-3  # m
...
projectname = "Square Patch Unit Cell " + current_time_str
designname = "MTS HFSS " + current_time_str
...
hfss.variable_manager.set_variable("solution_volume_height", expression="{}mm".format(solution_volume_height))
...
radiation_volume_size = [ground_plane_size[0], ground_plane_size[1], solution_volume_height]
radiation_volume_params = {"name": "solution_volume",
...
radiation_volume_geom.color = vacuum_color
...
solution_fields_surface_geom.color = vacuum_color
...
# propagation_volume_geom = radiation_volume_geom
# propagation_volume_position = radiation_volume_position
# propagation_volume_size = radiation_volume_size
