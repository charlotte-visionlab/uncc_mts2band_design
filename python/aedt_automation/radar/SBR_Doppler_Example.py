...
#aedt_version = "2023.1"
os.environ["ANSYSEM_ROOT221"] = "/opt/AnsysEM/v221/Linux64/"
aedt_version = "2022.1"
...
app.plot(show=False, export_path=os.path.join('.', "Image.jpg"), plot_air_objects=True)
