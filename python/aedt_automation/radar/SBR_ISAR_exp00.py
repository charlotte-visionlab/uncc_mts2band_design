...
radar_parameters = {
    ...
    'Nominal Operating Frequency': '25GHz',
    'Range Extent': '10m',  # X
    'Range Resolution': '0.1m',  # dX
    'Cross-Range Extent': '10m',  # Y
    'Cross-Range Resolution': '0.1m',  # dY
...
#                                                pitch=0,
#                                                roll=0)
reflector1 = hfss_geom.modeler.add_environment(env_folder=agm88_1,
                                               environment_name="AGM88_1",
                                               global_offset=[0, 0, 0],
                                               yaw=0,
                                               pitch=0,
                                               roll=0)
